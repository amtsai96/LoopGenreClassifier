...
(train_name, train_images, train_labels), (test_name, test_images, test_labels) = _load_data('1st_data/')
...
checkpoint_path = "train__sep/cp-{epoch:04d}.ckpt"
...
# Save the weights
weight_file = './checkpoints_sep/my_checkpoint'
model.save_weights(weight_file)
# Save entire model to a HDF5 file
model_name = 'sep_loop_genres_classifier.h5'
